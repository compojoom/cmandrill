...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cmandrill&view=templates'); ?>" method="post" name="adminForm"
	  id="adminForm">
			...
			<table class="table table-condensed table-striped">
				...
				<?php if (count($this->items)) : ?>
					<?php foreach ($this->items as $i => $template) : ?>
						...
						<td>
							<a href="<?php echo JRoute::_('index.php?option=com_cmandrill&task=template.edit&id='.$template->id); ?>" class="">
