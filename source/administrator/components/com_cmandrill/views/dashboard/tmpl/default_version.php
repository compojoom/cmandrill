...
<table width="100%" class="table table-version table-bordered table-striped-offset1 table-condensed">
	<tr>
		<th colspan="2">
			<div class="cmandrill-logo">
				<a href="https://compojoom.com/joomla-extensions/mandrill-transactional-emails-made-easy" target="_blank">
					<img src="<?php echo JUri::root(); ?>media/com_cmandrill/images/cmandrill-logo.jpg" align="middle" alt="Ccomment logo"/>
				</a>
			</div>
		</th>
	</tr>
	<tr>
		...
		<td>
			...
			<a id="hs-btn-reloadupdate" href="index.php?option=com_cmandrill&task=update.force&<?php echo JFactory::getSession()->getFormToken(); ?>=1"
	...
	<tr>
		...
		<td><?php echo CompojoomComponentHelper::getManifest('com_cmandrill')->get('creationDate'); ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><a href="http://www.gnu.org/licenses/gpl.html" target="_blank">GNU GPLv3 or later</a></td>
	</tr>
</table>
