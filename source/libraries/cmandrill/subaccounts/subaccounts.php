...
class CmandrillSubaccounts
{
	...
	public function getList($q = null)
	{
		...
		return $this->master->call('subaccounts/list', $params);
	}
	...
	{
		$params = array("id" => $id, "name" => $name, "notes" => $notes, "custom_quota" => $custom_quota);
	...
	public function info($id)
	{
		...
		return $this->master->call('subaccounts/info', $params);
	}
	...
	public function update($id, $name = null, $notes = null, $custom_quota = null)
	{
		...
		return $this->master->call('subaccounts/update', $params);
	}

	/**
	 * Delete an existing subaccount. Any email related to the subaccount will be saved, but stats will be removed and any future sending calls to
	...
	/**
	 * Pause a subaccount's sending. Any future emails delivered to this subaccount will be queued for a maximum of 3 days until the subaccount
	 * is resumed.
	 *
	...
	public function pause($id)
	{
		...
		return $this->master->call('subaccounts/pause', $params);
	}
	...
	public function resume($id)
	{
		...
		return $this->master->call('subaccounts/resume', $params);
	}
}
