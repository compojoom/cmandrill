...
class CmandrillIps
{
	...
	public function getList()
	{
		...
		return $this->master->call('ips/list', $params);
	}
	...
	public function info($ip)
	{
		...
		return $this->master->call('ips/info', $params);
	}
	...
	{
		$params = array("warmup" => $warmup, "pool" => $pool);

		return $this->master->call('ips/provision', $params);
	}
	...
	public function startWarmup($ip)
	{
		...
		return $this->master->call('ips/start-warmup', $params);
	}
	...
	public function cancelWarmup($ip)
	{
		...
		return $this->master->call('ips/cancel-warmup', $params);
	}
	...
	{
		$params = array("ip" => $ip, "pool" => $pool, "create_pool" => $create_pool);

		return $this->master->call('ips/set-pool', $params);
	}
	...
	public function delete($ip)
	{
		...
		return $this->master->call('ips/delete', $params);
	}
	...
	public function listPools()
	{
		...
		return $this->master->call('ips/list-pools', $params);
	}
	...
	{
		$params = array("pool" => $pool);

		return $this->master->call('ips/pool-info', $params);
	}
	...
	public function createPool($pool)
	{
		...
		return $this->master->call('ips/create-pool', $params);
	}
	...
	public function deletePool($pool)
	{
		...
		return $this->master->call('ips/delete-pool', $params);
	}
	...
	{
		$params = array("ip" => $ip, "domain" => $domain);

		return $this->master->call('ips/check-custom-dns', $params);
	}
	...
	public function setCustomDns($ip, $domain)
	{
		...
		return $this->master->call('ips/set-custom-dns', $params);
	}
}
