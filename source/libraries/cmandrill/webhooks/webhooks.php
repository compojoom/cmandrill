...
class CmandrillWebhooks
{
	...
	public function getList()
	{
		...
		return $this->master->call('webhooks/list', $params);
	}
	...
	{
		$params = array("url" => $url, "description" => $description, "events" => $events);

		return $this->master->call('webhooks/add', $params);
	}
	...
	public function info($id)
	{
		...
		return $this->master->call('webhooks/info', $params);
	}
	...
	{
		$params = array("id" => $id, "url" => $url, "description" => $description, "events" => $events);

		return $this->master->call('webhooks/update', $params);
	}
	...
	public function delete($id)
	{
		...
		return $this->master->call('webhooks/delete', $params);
	}
}
