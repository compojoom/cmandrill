...
class CmandrillTags
{
	...
	public function getList()
	{
		...
		return $this->master->call('tags/list', $params);
	}
	...
	public function delete($tag)
	{
		...
		return $this->master->call('tags/delete', $params);
	}
	...
	public function info($tag)
	{
		...
		return $this->master->call('tags/info', $params);
	}
	...
	public function timeSeries($tag)
	{
		...
		return $this->master->call('tags/time-series', $params);
	}
	...
	public function allTimeSeries()
	{
		...
		return $this->master->call('tags/all-time-series', $params);
	}
}
