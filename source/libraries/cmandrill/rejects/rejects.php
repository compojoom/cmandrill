...
class CmandrillRejects
{
	...
	{
		$params = array("email" => $email, "comment" => $comment, "subaccount" => $subaccount);

		return $this->master->call('rejects/add', $params);
	}
	...
	{
		$params = array("email" => $email, "include_expired" => $include_expired, "subaccount" => $subaccount);

		return $this->master->call('rejects/list', $params);
	}
	...
	{
		$params = array("email" => $email, "subaccount" => $subaccount);

		return $this->master->call('rejects/delete', $params);
	}
}
