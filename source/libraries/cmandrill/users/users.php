...
class CMandrillUsers
{
	 ...
	 *     - hourly_quota integer the maximum number of emails Mandrill will deliver for this user each hour.  Any emails beyond that will be accepted
	 *       and queued for later delivery.  Users with higher reputations will have higher hourly quotas
	...
	public function info()
	{
		...
		return $this->master->call('users/info', $params);
	}
	...
	public function ping()
	{
		...
		return $this->master->call('users/ping', $params);
	}
	...
	public function ping2()
	{
		...
		return $this->master->call('users/ping2', $params);
	}
	...
	public function senders()
	{
		...
		return $this->master->call('users/senders', $params);
	}
}
